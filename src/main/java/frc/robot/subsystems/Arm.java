...
public class Arm extends SubsystemBase{
    private double armTargetAngle = 110;
    ...
    public Arm() {
        m_armMotorLeft = new CANSparkMax(5, com.revrobotics.CANSparkLowLevel.MotorType.kBrushless);
        m_armMotorRight = new CANSparkMax(8, com.revrobotics.CANSparkLowLevel.MotorType.kBrushless);
        ...
        // HIGHER P CAUSES MORE OCCELATION. TOO
        // LOW CAUSES NO POWER/NOT ENOUGH
    ...
    public Boolean isAtTraget(){
        return Math.abs(armTargetAngle - angEncoder.getPosition()) < ArmConstants.kArmThreshold;
    }
    ...
    public void periodic() {
        double voltage = PIDController.calculate(angEncoder.getPosition(), armTargetAngle);
        m_armMotorRight.setVoltage(
            voltage
            );
        m_armMotorLeft.setVoltage(voltage);
        //System.out.println(armTargetAngle);
        //System.out.println(angEncoder.getPosition());
    }
}
